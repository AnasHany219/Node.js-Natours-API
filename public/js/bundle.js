...
var stripe = Stripe('pk_test_51PhMgCHpyJxp9TbBx9dAAKXV8kG8a64usjoAp06U4IQhUJnBSaYpl0rle2bBJRqm9MMOLKAGL62vPoRINLQ2cyx900BhzkB3Ex');
...
var updateSettings = exports.updateSettings = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(data, type) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          url = "http://localhost:5000/api/v1/users/".concat(type === 'Data' ? 'updateMe' : 'updateMyPassword');
          _context.prev = 1;
          _context.next = 4;
          return (0, _axios.default)({
            method: 'PATCH',
